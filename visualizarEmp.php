                        ...
                        <div class="informacoesesquerda">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="numInscricao" id="numInscricaoJS" value="<?php echo $dado['numero_empresa']; ?>" disabled="disabled">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="password" name="senha" class="form-control" id="senhaJS" value="<?php echo $dado['senha_endereco']; ?>" disabled="disabled">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="confSenha">Confirmar senha </label>
                                    <input type="password" name="confSenha" class="form-control" id="confSenhaJS" value="<?php echo $dado['confSenha_endereco']; ?>" disabled="disabled">
                                </div>
                            </div>
